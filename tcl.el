;;
;; Name		tcl.el
;; Description	Tcl code editing commands for Emacs
;; Version	$Id: tcl.el,v 1.3 1997/07/17 11:18:54 akos Exp $
;; Comments	A few modifications to Tom Tromey's tcl.el
;;
